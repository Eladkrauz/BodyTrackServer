...
from Components.PoseAnalyzer import PoseLandmark, PoseLandmarksArray
from Components.SessionManager import ExerciseType as ExerciseType
...
class JointAngle:
    ...
    def exercise_type_to_joint_type(exercise_type:ExerciseType) -> 'JointAngle':
        ...
        else: ErrorHandler.handle(error=ErrorCode.EXERCISE_TYPE_DOES_NOT_EXIST, origin=inspect.currentframe())
        return None
...
class JointAnalyzer:
    ...
    def calculate_joints(
        ...
        try:
            ...
            exercise_joints:list[Joint] = exercise_type.CORE + exercise_type.EXTENDED
