...
_error_descriptions = {
    ...
    ErrorCode.CLIENT_IS_NOT_REGISTERED:                 "Not registered to the system.",
    ErrorCode.CLIENT_IS_ALREADY_REGISTERED:             "Already registered to the system.",
    ErrorCode.CLIENT_IS_NOT_ACTIVE:                     "Not in an active session.",
    ErrorCode.CLIENT_IS_ALREADY_ACTIVE:                 "Already in an active session.",
    ErrorCode.CLIENT_IS_NOT_PAUSED:                     "Not in a paused session.",
    ErrorCode.CLIENT_IS_ALREADY_PAUSED:                 "Already in a paused session.",
    ErrorCode.CLIENT_IS_NOT_ENDED:                      "Not in an ended session.",
    ErrorCode.CLIENT_IS_ALREADY_ENDED:                  "Already in an ended session.",
    ErrorCode.CLIENT_IS_ONLY_REGISTERED:                "Only registered, did not start yet.",
    ...
    ErrorCode.CLIENT_NOT_IN_SYSTEM:                     "Not registered in the system.",
